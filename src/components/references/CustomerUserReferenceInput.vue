...
import { createCustomerUserReference } from "@/references/customerReferences";
...
const reference = computed(() => {
	const customerId = typeof props.customerId === "number" && props.customerId > 0
		? props.customerId
		: null;
	const baseReference = createCustomerUserReference(customerId);
